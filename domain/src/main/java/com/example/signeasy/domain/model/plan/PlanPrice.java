...
public class PlanPrice {
    @EmbeddedId
    private PlanPriceKey key = new PlanPriceKey();
    ...
    public PlanPrice(PlanPriceKey key, Plan plan, Period period, long priceCents, boolean active) {
        this.key = key;
        setPlan(plan);
        this.period = period;
    ...
    public PlanPriceKey getKey() {
        return key;
    }

    public void setKey(PlanPriceKey key) {
        this.key = key;
    }
